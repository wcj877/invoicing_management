        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <div class="row w-100">
                        <div class="col-md-12">
                            <h4 class="header-title float-left">所有客户</h4>
                            <a href="#custom-modal" class="btn btn-primary waves-effect w-md mr-2 mb-2 float-right"
                               ...
                               data-overlaySpeed="100" data-overlayColor="#36404a">添加客户</a>
                        </div>
                    </div>
...
<div id="custom-modal" class="modal-demo" style="margin-top: 20%; height: 860px">
    ...
    <form class="form-horizontal m-2" method="post"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="" name="clientContact">
            </div>
        </div>
...
<script src="public/js/jquery.sweet-alert.client.js"></script>
