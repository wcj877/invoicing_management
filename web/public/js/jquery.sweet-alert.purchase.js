        ...
        $(document).on('click', '#sa-warning', function () {
            ...
            swal({
                ...
                if (dismiss['dismiss'] === 'cancel') {
                    ...
                    $.ajax({
                        url: "ProductServlet",
                        data: "method=delete&productId=" + name,
        ...
        $(document).on('click', '#custom-html-alert', function () {
            ...
            var s = swal({
                ...
                html: '<form class="form-horizontal">' +
                    ...
                    '<div class="col-sm-10">' +
                    '<input  type="text" class="form-control" id="productName" value="' + parents.eq(3).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '<div class="form-group row">' +
                    '<label class="col-sm-2 col-form-label">商品描述</label>' +
                    '<div class="col-sm-10">' +
                    '<input type="text" class="form-control" id="describes" value="' + parents.eq(2).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '</form>',
