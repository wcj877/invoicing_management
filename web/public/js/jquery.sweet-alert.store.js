        ...
        $(document).on('click', '#custom-html-alert', function () {
            ...
            var s = swal({
                ...
                html: '<form class="form-horizontal">' +
                    ...
                    '<div class="col-sm-10">' +
                    '<input  type="text" class="form-control" id="storeName" value="' + parents.eq(3).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '<div class="form-group row">' +
                    '<label class="col-sm-2 col-form-label">仓库地址</label>' +
                    '<div class="col-sm-10">' +
                    '<input type="text" class="form-control" id="address" value="' + parents.eq(2).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '<div class="form-group row">' +
                    '<label class="col-sm-2 col-form-label">描述</label>' +
                    '<div class="col-sm-10">' +
                    '<input type="text" class="form-control" id="storeDescribe" value="' + parents.eq(0).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '</form>',
            ...
            s.then(function (dismiss) {
                ...
                if (dismiss['dismiss'] === 'cancel') {
                    ...
                    $.ajax({
                        url: "StoreServlet",
                        data: "method=update&name=" + name + "&address=" + address + "&describe=" + describe + "&id=" + id,
                        success: function (data) {
                            if (data === "OK") {
                                swal({
                                    title: '提交中',
                                ...
                                console.log(parents);
                                parents.eq(3).text(name);
                                parents.eq(4).text(id);
                                parents.eq(2).text(address);
                                parents.eq(0).text(describe);
                            } else {
                                swal({
                                    title: '发生错误',
                                    text: "修改信息失败",
