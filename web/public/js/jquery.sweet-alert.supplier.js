        ...
        $(document).on('click', '#custom-html-alert', function () {
            ...
            var s = swal({
                ...
                html: '<form class="form-horizontal">' +
                    ...
                    '<div class="col-sm-10">' +
                    '<input  type="text" class="form-control" id="supplierContact" value="' + parents.eq(1).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '<div class="form-group row">' +
                    '<label class="col-sm-2 col-form-label">电话</label>' +
                    '<div class="col-sm-10">' +
                    '<input type="text" class="form-control" id="supplierPhone" value="' + parents.eq(0).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '</form>',
