        ...
        $(document).on('click', '#custom-html-alert', function () {
            ...
            var s = swal({
                ...
                html: '<form class="form-horizontal">' +
                    ...
                    '<div class="col-sm-10">' +
                    '<input type="text" class="form-control" id="staffName" value="' + parents.eq(1).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '<div class="form-group row">' +
                    '<label class="col-sm-2 col-form-label">职务</label>' +
                    '<div class="col-sm-10">' +
                    '<input type="text" class="form-control" id="duty" value="' + parents.eq(0).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '<div class="form-group row">' +
            ...
            s.then(function (dismiss) {
                ...
                if (dismiss['dismiss'] === 'cancel') {
                    ...
                    $.ajax({
                        url: "StaffServlet",
                        data: "method=update&name=" + name + "&duty=" + duty+ "&password=" + password + "&id=" + id,
                        success: function (data) {
                            if (data === "OK") {
                                swal({
                                    title: '提交中',
                                ...
                                console.log(parents);
                                parents.eq(1).text(name);
                                parents.eq(2).text(id);
                                parents.eq(0).text(duty);
                            } else {
                                swal({
                                    title: '发生错误',
                                    text: "修改信息失败",
