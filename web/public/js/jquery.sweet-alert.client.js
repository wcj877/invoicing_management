        ...
        $(document).on('click', '#custom-html-alert', function () {
            ...
            var s = swal({
                ...
                html: '<form class="form-horizontal">' +
                    ...
                    '<div class="col-sm-10">' +
                    '<input  type="text" class="form-control" id="clientContact" value="' + parents.eq(1).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '<div class="form-group row">' +
                    '<label class="col-sm-2 col-form-label">电话</label>' +
                    '<div class="col-sm-10">' +
                    '<input type="text" class="form-control" id="clientPhone" value="' + parents.eq(0).text() + '">' +
                    '</div>' +
                    ' </div>' +
                    '</form>',
            ...
            s.then(function (dismiss) {
                ...
                if (dismiss['dismiss'] === 'cancel') {
                    ...
                    $.ajax({
                        url: "ClientServlet",
                        data: "method=update&name=" + name + "&phone=" + phone+ "&id=" + id,
                        success: function (data) {
                            if (data === "OK") {
                                swal({
                                    title: '提交中',
