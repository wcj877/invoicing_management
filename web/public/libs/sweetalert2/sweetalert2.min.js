!function (e, t) {
    ...
    var x = {
            ...
            useRejections: !1,
            expectRejections: !1
        }, A = ["useRejections", "expectRejections"], T = function (e) {
    ...
    var le = [], ce = function () {
            ...
            isValidParameter: T, isDeprecatedParameter: j, argsToParams: function (n) {
                var o = {};
                switch (q(n[0])) {
                    case"string":
            ...
            }, close: C, closePopup: C, closeModal: C, closeToast: C, isVisible: function () {
                return !!Z()
            }, clickConfirm: function () {
                return G().click()
            }, clickCancel: function () {
                return ee().click()
            }, getPopup: Z, getTitle: Y, getContent: $, getImage: J, getIcons: Q, getButtonsWrapper: function () {
            ...
            }, showLoading: ce, enableLoading: ce, getTimerLeft: function () {
        ...
        me = {promise: new fe, innerParams: new fe, domCache: new fe};

    function he() {
        var e = me.innerParams.get(this), t = me.domCache.get(this);
    ...
    var be = Object.freeze({
        hideLoading: he, disableLoading: he, getInput: function (e) {
            var t = me.innerParams.get(this), n = me.domCache.get(this);
    ...
    }), Ce.DismissReason = e, Ce.noop = function () {
    }, Ce.version = "7.25.0";
