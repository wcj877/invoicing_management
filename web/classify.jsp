        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <div class="row w-100">
                        <div class="col-md-12">
                            <h4 class="header-title float-left">所有分类</h4>
                            <a href="#custom-modal" class="btn btn-primary waves-effect w-md mr-2 mb-2 float-right"
                               ...
                               data-overlaySpeed="100" data-overlayColor="#36404a">添加分类</a>
                        </div>
                    </div>
...
<div id="custom-modal" class="modal-demo" style="margin-top: 20%; height: 860px">
    ...
    <%--    </button>--%>
    <h4 class="custom-modal-title">添加分类</h4>
    <form class="form-horizontal m-2" method="post"
          action="${pageContext.request.contextPath}/ClassifyServlet?method=insert"
...
<script src="public/js/jquery.sweet-alert.classify.js"></script>
