    ...
    <div class="container-fluid">
        ...
        <div class="page-title-box">
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item"><a href="javascript:void(0);">销售管理</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <div class="row w-100">
                        <div class="col-md-12">
                            <h4 class="header-title float-left">所有销售订单</h4>
                            <a href="#custom-modal" class="btn btn-primary waves-effect w-md mr-2 mb-2 float-right"
                               ...
                               data-overlaySpeed="100" data-overlayColor="#36404a">添加销售订单</a>
                        </div>
                    </div>
                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                        ...
                        <c:forEach var="salesOrder" items="${requestScope.salesOrderList}">
                            <tr>
                                ...
                                <td>${salesOrder.productName}（编号${salesOrder.productId}）</td>
                                <td>${salesOrder.clientName}</td>
                                <td>${salesOrder.staffName}</td>
                                <td>${salesOrder.time}</td>
                                <td>${salesOrder.salesNumber}</td>
